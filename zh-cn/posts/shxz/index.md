...
> 我一直想找机会记录下我第一次接触到“新政治经济学”的震撼。现在决定梳理一番是基于以下原因：
> - 学了测度论后，有了一点点泛函和实分析基础
> - 组会上老师聊到了一点国内现状，提到政治经济学确实是一个很重要的视角
...
我经常在博客里用这个问题举例[^3]——政府起源原因是什么？一种流派是古典政治经济学，以社会契约论、公共物品论[^2]、社会福利理论为代表。权力集体的设置源于集体最优化的需求。
...
在引入另外一个流派以前，我们先看看下一个问题——什么决定了国家的发展。

一大流派是国际贸易视角下的资源禀赋理论。一号国家既有 2 个a 资源，又有 2 个b 资源，但 a 产业赚钱更多，自然就会选择 a 产业。二号国家只有 0.5 个 a 资源，又有 1 个 b 资源，因此 b 产业赚钱更多，于是发展 b 产业。
...
> 以下关于制度经济学的区分，参考了《制度与经济增长》（姚洋），这本书是关于姚洋教授和制度经济学大师诺斯的交流对话。

制度经济学并不这么认为，或者说，他们认为制度很重要（例如 2024 年诺奖得主 Daron）。禀赋资源说总是考虑人们会理性地使得自己资源优势最大化，那么举一个简单的反驳例子——逆全球化趋势也在全球局部出现。

> **例子 1**. 科斯使用交易成本解释企业的起源——从制度层面解释了企业的产生。
> 
> **例子 2**、我更想用人类学的一种观点解释制度经济学——我们的文化行为可以被看作一种过度仪式[^4]。例如腊肉，过去腊肉作为过年的食物是因为便于保存，受到资源限制而产生的行为，但如今资源丰富了，腊肉的意义成为了新年美食的化身。

也就是说，制度演化混杂了太多非理性因素于非物质因素，尤其是文化宗教这类。如何认识这种制度中非最优、非完全理性的制度演化，制度经济学又分为了新制度经济学学派（如 Dron）和旧制度经济学派（例如萨缪尔森（Samuelson））。

换句话讲，比起将集体作为一个单位，制度经济学注重“人——集体——制度——发展”的互动和动态演化。

> 新旧制度经济学的区别其实很模糊，这里推荐《制度与经济增长》（姚洋）[^5]这本书。
> 
...
于是社会选择理论诞生了，例如代理人[^6]、官员晋升锦标赛[^7]、包容性增长。今天我想介绍的就是社会选择理论中的投票相关的分析。一切集体决策都可以看作一种投票。
...
我们曾在概率论中使用集合表示事件结果范围，而泛函之所以为“泛”，就是因为它研究的函数是**集合空间到集合空间的映射**；非线性泛函则是一种路径最优化，可以参考另外一偏博客《[变分法学习笔记](https://blog.huaxiangshan.com/zh-cn/posts/bff/)》。

高级微观的一些推理依赖集合作为要素空间进行表达：
...
$$
> 注意，这里是所有个体的偏好空间到社会偏好的映射，并不一定是数轴那种空间。个体联合偏好空间可以理解为所有人偏好的结果都集合，社会偏好空间可以理解为最后我们觉得应该承认的总体偏好结果。
...
5. $K\subseteq I$ 是决定性的，且成员数量大于 1，存在真子集 $J\subset K$ 为决定性的。（感觉就和测度论中取 $\sigma$ 代数一样）
