...
> 我一直想找机会记录下我财政课上第一次接触到“新政治经济学”的震撼。现在决定梳理一番是基于以下原因：
> - 学了测度论后，有了一点点泛函基础（其实不需要）
> - 组会上老师聊到了一点国内政策执行现状，提到政治经济学确实是一个很重要的视角
...
制度经济学并不这么认为，或者说，他们认为制度很重要（例如 2024 年诺奖得主 Daron）。禀赋资源说总考虑人们会理性地使得自己资源优势最大化，那么举一个简单的反驳例子——逆全球化趋势也在全球局部出现。
...
也就是说，制度演化混杂了太多非理性因素与非物质因素，尤其是文化宗教这类。如何认识这种制度中非最优、非完全理性的制度演化，制度经济学又分为了新制度经济学学派（如 Dron）和旧制度经济学派（例如萨缪尔森（Samuelson））。
...
我们曾在概率论中使用集合表示事件结果范围，而泛函之所以为“泛”，就是因为它研究的函数是**集合空间到集合空间的映射**；非线性泛函则是一种路径最优化，可以参考另外一篇博客《[变分法学习笔记](https://blog.huaxiangshan.com/zh-cn/posts/bff/)》。
...
$$
> 注意，这里是所有个体的偏好空间到社会偏好的映射，并不一定是数轴那种空间（$R^1$）。个体联合偏好空间可以理解为所有人偏好的结果的集合，社会偏好空间可以理解为最后我们应该承认的总体偏好结果空间。
