...
个人觉得**文人相轻**的意识形态在学术界还是比较重的，实际上审稿需要更加包容的心态。
...
审稿人有自己的标准，期刊也有自己的标准。注意自己的标准不要轻易地超过期刊的标准。同时，我想，最好的学术市场上是减少“xx 问题没意思，无聊，不值得研究”这种带有个人偏见的想法。审稿最好的立场不是 xx 值得研究，xx 不值得研究，而是 xx 在目前条件下 xx 地方探索的还不够。

挑错，知道实证内生性的概念后，谁都可以做，为论文提出有建设性的，可以拓展研究的建议，才是真正考验审稿人能力的地方。
## 个人流程
...
只破不立没人爱。我们要知道所有研究都是在有约束的情况下做的。我们不可能要求作者去解决没法解决的问题（比如没数据变量）。因此，最好在提出问题后，给出自己觉得或许可以参考且比较可行的解决办法。例如 xx 问题，作者或许可以考虑 xx......
## 选题和创新性

虽然我不赞成以貌取文，但实际上很多人看到标题的 xy 和研究对象就会觉得 xx 研究不靠谱，不存在因果关系，xx 对象不值得研究。这不是默认自己的经济直觉凌驾于一篇论文的实证结果之上吗？总之这种风气肯定反应了学术圈和实证方法背后的某些问题😅。这也启示了我们标题和摘有有多么重要[^4]。
...
一般而言，文献综述会突出以往研究了什么，本文与哪些文献进行了对话，得到了更新的结果。可以考虑作者是否真正的呼应的对饮的文献，或者还有些被忽略的文献，其实作者已经对话了但是作者尚未发现。
...
更高一级的要求是政策建议，结论和启发是需要考虑成本收益的。一个文章分析出 x 对 y 有影响，这个是经济规律，但是如何基于这个经济规律提出建议，需要考虑更大的政策成本收益。

> 不过这是更高，但是实际上更符合现实全局考虑的角度：

例如，提出建议通过政府投资放松信贷约束能促进小微企业发展，那么这个政策建议至少蕴含了多个前提需要考虑。1、为什么是小微企业，投资选择大企业和小微企业之间的内在取舍是什么？2、既然经济本质是投资，关键是信贷约束，那放松信贷约束的渠道只有投资吗？3、成本收益，如果有相关的政策依据会比较出彩。所以政策的意外，溢出效果同时比较好写，因为都意外效果了，其实就是额外的好处。
## 推荐参考
...
[^4]: 实际上如果你分析论文格式的每个结构的作用，会发现每一个地方都很重要。
