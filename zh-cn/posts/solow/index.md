...
1987年诺贝尔经济学奖获得者罗伯特·默顿·索洛（Robert Merton Solow）于2023年12月21日去世，享年99岁。本篇博客，主要是以纪念为主要目的[^1]。

虽然索洛模型的假设比较严格[^2]，如今已经让位给后面的模型，但他开创了新古典“经济增长”的分析范式，其结论产生的“**全要素生产力**”（索洛余值）成为了如今经济体最在意的指标之一。
...
例如上面这个式子，简单来说，就是刻画资本**增长率**（$\dot{k}$）和**人均**资本**存量**（${k}$）的关系。

**收敛**意味着人均资本增长到一定水平后，增长率很难继续增加，反而趋近于 0。表现在式子中就是： $△k=0=\dot{k}=f(k)$。

> 就像马尔萨斯人口陷阱，人均收入变高了，人们富裕了，更容易生育，人口增多，人均收入就下降。人均收入下降，人们变穷了，减少生育，人口变少，人均收入又上升。这个拉拉扯扯让人均收入趋于稳定的过程，就是人均收入和人均收入变化率互相牵制的过程。
> 
> Solow 模型在这之上进行了更多的分解。起点低，进步速度可能更快；起点高，进步速度可能更慢。Solow 模型想解释的是“低收入国家的发展速度在早期是大于高收入国家”这个现象。
...
相对于 python，matlab 和 stata 一样，目前尚占据主流是因为大部分论文代码给的文件是 `.m` 和 `.do`。但随着模型越来越复杂，python 在优化代码，调整算法进行计算方面具有更大优势。我看到很多做宏观模型的研究同学都开始使用 python 来优化计算过程。
{{< /admonition >}}
