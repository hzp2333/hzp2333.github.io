...
> Give civilization to time, rather than giving time to civilization[^17]
> 
>—— *The Dark Forest*
...
I think Zhao Dingxin's [Zhao Dingxin | Structural-mechanism explanations and the development of structural-mechanism relations after the Big Bang](https://mp.weixin.qq.com/s/ce8kI3MuK40UHcMQbotNWg) does a very good job summarizing what Malthus leaves out:
...
Challenging the academic mainstream is obviously hard. Beyond its theoretical models, the book also reflects on scientific concepts and methodology. I have always felt that — <font color="#ff0000">the best social scientists are really selling a worldview</font>.
...
> 
> —— Gregory Clark ([Gregory Clark](https://en.wikipedia.org/wiki/Gregory_Clark_(economist)))

![As the chart shows, world per capita income is usually divided into two periods: before Malthus and after Malthus](/img/富种起源-20250118181734292.webp)

![Height data seems to move in sync as well](/img/富种起源-20250118181710751.webp)

### Interesting questions

When you look at historical trend charts like these, a few questions naturally come up:

![Image source: Wikipedia. Maddison's estimates of per capita GDP for selected European and Asian countries from 1500 to 1950, measured in 1990 international dollars at purchasing power parity. It shows the explosive growth of Western Europe and Japan in the nineteenth century.](/img/富种起源-20250118180725493.webp)
...
The extended discussion around unified growth models is fascinating. At first, the most interesting issue to me was the Needham Question, which came from a high school history teacher who gave me *The Gains and Losses of Economic Reform Through the Dynasties*[^10]. As for evolution, I owe that interest to senior Z, who gave me *The Selfish Gene* 😍.


> For my own reading notes on *The Selfish Gene*, see [The Selfish Gene: The Question of Altruistic Morality](https://blog.huaxiangshan.com/en/posts/selfishgene/).

Related questions: the Needham Question[^1], the Weber Question[^2], the Great Divergence[^3]...... 

![Just recording an old undergraduate methods assignment here](/img/富种起源-20250118214826184.webp)
...
{{< admonition type=note  title="Thought" open=false >}}
It is exactly because this narrative has become mainstream that development economics today is largely the domain of labor economics and economic history.
{{< /admonition >}}
...
People's preference for utility goods rises (the indifference curve becomes flatter).
At that point equilibrium lies below the population-equilibrium line (the production possibility frontier expands).
A new equilibrium is eventually formed.
...
![As shown](/img/富种起源-20250118181630328.webp)
...
This also helps explain why **explosive wealth growth and falling fertility seem to move together, even though our living standards are genuinely improving** [^12]. Many people reduce the reason to child-rearing costs, but the framework of *The Origin of Rich Species* can absorb that point too: education, housing, and medical care, all of which count as subsistence goods, have today been turned by consumerism into utility goods. **That conversion of subsistence goods into utility goods massively raises social welfare, but the price is weaker fertility on the whole**[^13].
...
1. The earlier two-sector model already suggested that when preference for utility goods rises, social welfare rises too.
2. Population then flows in naturally, and the production possibility frontier shrinks again.
3. The system eventually returns to a new equilibrium.

![As shown](/img/富种起源-20250118190245891.webp)
...
> Fossil evidence from Cretaceous ostracods suggests that only populations with reproductive organs of moderate length were able to persist. The longer the organs, the lower the probability of long-term continuation[^4].
...
That is also why evolution did not make everyone morally noble. Just like the dark forest in *The Three-Body Problem*[^14], malice becomes a kind of subsistence good in the game of group competitive selection.
...
![Computer simulation result](/img/富种起源-20250118193222032.webp)
## Unified theory
...
Jones (2001) builds a theoretical model that uses population structure as the bridge. The Malthusian trap assumes that when people get richer, they have more children, but in reality fertility falls once a society becomes rich enough. Technology strengthens that trend, and the Industrial Revolution was the turning point[^5]. 

Galor and Weil (2000) work with two trade-offs: 1. pleasure versus child-rearing, since raising children sacrifices one's own enjoyment; 2. childbirth versus child quality. There is an equilibrium between the return to fertility and the cost of child-rearing[^6].  

Galor and Moav (2002) strengthen the role of educational accumulation on that basis, linking the Industrial Revolution, education, and the accumulation implied by gene-selection theory[^7].  
...
Take an analogy from Liu Cixin's *Ball Lightning*: it is not that ball lightning appears out of nowhere; rather, its disguise goes from present to absent[^9]. It is not that the sun moves, but that the earth moves. Many people think happiness is something brought into existence, but perhaps happiness is only the easing of pain.  
...
2. Innovation in knowledge media
3. An explosion of utility goods

![As shown](/img/富种起源-20250118200017478.webp)
...
{{< admonition type=note  title="A thought experiment" open=false >}}
...
<center><font color="#ff0000">Beside the sunken ship, a thousand sails pass by; before the sick tree, ten thousand saplings bloom in spring.</font></center>
...
![Computer simulation result](/img/富种起源-20250118201827549.webp)
...
Once we realize that economic growth is actually the brief flare in the long river of history, while stagnant equilibrium makes up most of history's surface, some of our real-world anxiety eases. Quiet permanence is always there, extinction may well be the end of the universe, yet life keeps cycling and renewing itself. In the end, the philosophy of this book is not so different from *The Lion King*, *21 Lessons for the 21st Century*, and *Wisteria Waterfall*[^11].
...
![I recently read *Jianlai*, so this hit me especially hard](/img/富种起源-20250118224501199.webp)
...
![As shown](/img/富种起源-20250118201943319.webp)
...
[^1]: Despite China's many important contributions to the development of human science and technology in antiquity, why did modern science and the Industrial Revolution not arise in China?
[^2]: Why did Eastern societies such as China and India fail to follow a path of rationalization in politics, economics, science, and even art that was independent of the West?
[^3]: In the nineteenth century, the Western world overcame growth constraints and surpassed the formerly dominant, or comparable, civilizations of the Middle East and Asia.
...
[^9]: In Liu Cixin's novel, ball lightning is a kind of macro-atom that is hard to observe with the naked eye and becomes noticeable mainly when it reacts with lightning.
[^10]: This book is about economic cycles and also argues that modern Chinese economics is in some sense a continuation of ancient ideas. At the time, debates over the advance and retreat of the state were very popular, and the book broadly shared that tone.
[^11]: A middle-school text. I remember it so clearly because a teacher once asked in class what the theme of *Wisteria Waterfall* was, and I happened to know the answer, so the impression stuck.
[^12]: Could this also be mocking the shaky core of cyberpunk? In Marxist political economy, this topic is called human alienation.
[^13]: Perhaps it can be understood as an intergenerational cost.
[^14]: Suppose an advanced civilization discovers a less advanced one. To prevent itself from being attacked first, the optimal game-theoretic strategy is to strike first.
[^15]: For example, the baby boom in a Year of the Dragon reflects the joint effect of long-term superstition and population structure: cyclical, repetitive, and powered by massive inertia.
[^16]: A term from Steven N. S. Cheung, referring to definitions that rely on description but cannot prove themselves, such as calling a four-legged bug a bug with four legs.
[^17]: This line is from *The Three-Body Problem* (*The Dark Forest*). In the novel, it is described as coming from Blaise Pascal. But after looking through online discussions, I think Pascal only wrote passages or long sentences with a roughly similar meaning. Most people seem to agree that Liu Cixin partly invented this line.
[^18]: The methodological paradigm of *The Origin of Rich Species* feels closer to the statistical paradigms used in biology, public health, and computational social science: simulation-based modeling.
