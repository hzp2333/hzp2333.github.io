...
> Give civilization to time, not time to civilization[^17]
>
...
Challenging mainstream academic views is undoubtedly a difficult process. Beyond discussing theoretical models, this book contains reflections on scientific concepts and methodological points. I have always believed that—<font color="#ff0000">top-tier social scientists are selling worldviews</font>.
...
>
> —— Gregory Clark (economist) ([Gregory Clark](https://en.wikipedia.org/wiki/Gregory_Clark_(economist)))

![As shown, world per capita income is generally divided into two periods: pre-Malthusian and post-Malthusian](/img/富种起源-20250118181734292.webp)

![As shown, height data appears to follow a similar pattern](/img/富种起源-20250118181710751.webp)

### Interesting Questions

Seeing such historical trend charts inevitably raises the following questions:

![Source: Wikipedia. Maddison's estimates of per capita GDP in selected European and Asian countries from 1500 to 1950, calculated in 1990 international dollars purchasing power parity. Shows explosive growth in Western Europe and Japan in the 19th century.](/img/富种起源-20250118180725493.webp)
...
Related issues: Needham Question[^1], Weber Question[^2], Great Divergence[^3]...

![Incidentally recording past undergraduate methodology assignments](/img/富种起源-20250118214826184.webp)
...
{{< admonition type=note  title="Reflection" open=false >}}
...
When societal preference shifts toward luxury goods (indifference curves flatten).
Equilibrium falls below the population equilibrium line (production possibility frontier expands).
...
$$
g\_{social welfare}=\beta(g\_{luxury goods}-g\_{subsistence goods})
$$
...
***The Selfish Gene* argues genetic competition best explains evolution.** But this equation refutes this—In practice, mainstream biology also recognizes **group competition plays a significant role in evolution**.
...
> Cretaceous ostracod fossil evidence indicates—only populations with moderate reproductive organ length could persist. Longer reproductive organs actually lowered persistence probability[^4].
...
This explains why evolution hasn't made everyone morally superior. Like the Dark Forest in *The Three-Body Problem*[^14], malice becomes a survival good in group selection games.

**Thus we reach a conclusion—globally, subsistence goods and luxury goods grow at nearly identical rates.**

![Computer simulation results](/img/富种起源-20250118193222032.webp)
...
Jones (2001)'s theoretical model uses population structure as the bridge. The Malthusian Trap assumes wealth leads to reproduction, but reality shows societies reduce fertility beyond certain wealth levels. Technology reinforces this trend, with the Industrial Revolution as the turning point[^5].

Galor and Weil (2000)'s model contains two trade-offs: 1. Pleasure vs. child-rearing—raising children sacrifices personal pleasure. 2. Fertility vs. child-rearing—equilibrium between reproductive returns and rearing costs[^6].

Galor and Moav (2002) strengthen education accumulation's role based on previous work. Connecting the Industrial Revolution, education, and genetic selection theory accumulation[^7].
...
Hansen and Prescott (2002) attempt technological transition explanations. Early productivity scarcity meant reliance on land as production factor. Post-Industrial Revolution, technological progress replaced land exploitation, enabling explosive wealth growth[^8].
...
Consider Liu Cixin's *Ball Lightning*—not ball lightning emerging from nothingness, but its camouflage disappearing[^9]. Not the sun moving, but Earth rotating. Many believe happiness emerges from nothingness, but happiness might be relief from suffering.
...
<center><font color="#ff0000">A thousand sails pass by the sunken boat; ten thousand saplings spring up before the withered tree.</font></center>
...
![Computer simulation results](/img/富种起源-20250118201827549.webp)
...
![Recently read *Sword Coming*, hence deep feelings about this](/img/富种起源-20250118224501199.webp)
...
**Empirical methods**. The author also analyzes selection theory as tautological[^16]. Unlike mainstream counterfactuals for same objects, this book's method involves computer simulation of growth scenarios and seeking non-biological counterfactuals—undeniably completely different from contemporary economics' mainstream methods. Utility sector economic growth rates and survival sector economic growth rates still lack mainstream econometric estimation strategies[^18].
...
[^1]: Despite China's many important contributions to human technological development, why didn't the Scientific and Industrial Revolutions occur in modern China?
[^2]: Why didn't Eastern societies like China and India embark on rationalization paths independent of the West in political, economic, scientific, and artistic fields?
[^3]: The Western world overcame growth limitations in the 19th century, surpassing previously dominant or comparable Middle Eastern and Asian civilizations.
...
[^9]: In Liu Cixin's novel, ball lightning is a macro-atom difficult to observe with naked eyes, only noticeable when reacting with lightning.
[^10]: This book discusses economic cycle theory, arguing modern Chinese economy continues ancient thought. When national advance-retreat theory was popular, this book followed similar tone.
[^11]: Middle school text. I remember vividly because during class, teacher asked *Wisteria Waterfall*'s theme; I happened to recall and answered correctly, deepening the impression.
[^12]: Does this also讽刺赛博朋克的内核站不住脚？In Marxist political economy, this topic is called human alienation.
[^13]: Perhaps considered intergenerational cost.
[^14]: Assuming an advanced civilization discovers a primitive civilization, to prevent being attacked first, optimal game strategy is attacking first.
[^15]: For example, Dragon Year baby boom results from long-term superstition and population structure interaction, cyclical, with enormous inertial force.
[^16]: From Zhang Wuchang—some definitions relying on description cannot self-prove, e.g., four-legged insect is insect with four legs.
[^17]: This phrase originates from *The Three-Body Problem* (Dark Forest). In *The Three-Body Problem*, described as from Blaise Pascal. But based on online discussions, Pascal's writings only contain similar-meaning paragraphs or long sentences. Generally considered semi-fabricated by Liu Cixin.
[^18]: *The Origin of Wealth*'s methodological paradigm more resembles biology, public health, computational social science statistical paradigms—simulation modeling.
