...
The author, Dawkins, himself complained in the 30th-anniversary introduction[^1]:
...
{{< admonition tip "Do You Truly Understand Evolutionary Theory?" false >}}
...
![Internet image, Digimon evolution path: For individual selection theory, natural selection resembles Digimon super-evolution—individual traits change for survival](/img/《自私的基因》：利他道德之问.zh-cn-20240523092624575.webp)
...
![Self-drawn image, a genetic hourglass: For gene selection theory, individuals are merely gene carriers; natural selection filters existing genes, then recombines them into more stable states. This book terms organisms as "survival machines" for genes.](/img/《自私的基因》：利他道德之问.zh-cn-20240523092656110.webp)


The author chooses to **treat "genes" as the fundamental unit of natural selection**[^2].
...
![Self-drawn image: Resembles choosing an observation coordinate. Everyone knows natural selection exists, but from what perspective should we observe it? This too presents a significant challenge](/img/《自私的基因》：利他道德之问.zh-cn-20240523092732445.webp)
...
The chapter logic essentially follows[^4]:

$$
\begin{align}
& \text{Biological behavior} \Rightarrow \text{why race/individual selection is wrong} \Rightarrow \text{gene selection} \newline
& \text{Altruistic behavior motivation} \Rightarrow \text{profit} - \text{cost} \geq 0
\end{align}
$$
...
![Self-drawn image, logical paradigm: This book's logic isn't observing b from a, but comparing nature's filtering of all species, examining genes from evolutionary processes, first identifying correlations between genes and behaviors, then conducting mental model interventions, finally screening for causality.](/img/《自私的基因》：利他道德之问.zh-cn-20240523092807957.webp)
...
$$
\begin{align}
& \text{Superficially altruistic: } P_{\text{individual}} - C_{\text{individual}} \leq 0 \newline
& \text{Actually selfish: } P_{\text{gene}} - C_{\text{gene}} \geq 0
\end{align}
$$

![Self-drawn image: More detailed breakdown of each chapter's content framework](/img/《自私的基因》：利他道德之问.zh-cn-20240523092837653.webp)
...
> _Since the beginning of the 21st century, some biologists have argued for an extended evolutionary synthesis, which would account for the effects of non-genetic inheritance modes, such as epigenetics, parental effects, ecological inheritance and cultural inheritance, and evolvability ([Wikipedia](https://en.wikipedia.org/wiki/Evolution#History_of_evolutionary_thought))._

Searching WOS with "selfish gene" as the subject[^6], then visualizing recent research through CiteSpace.
...
![Appears to have limited positive research](/img/《自私的基因》：利他道德之问.zh-cn-20240523092909498.webp)
...
![Often called "memes"; in the CITIC Publishing version I read, it's translated as "觅母" (seeking mother).](/img/《自私的基因》：利他道德之问.zh-cn-20240523092941784.webp)
...
"Sapiens: A Brief History of Humankind" introduced me to **de-anthropocentrism**. Homo sapiens is merely one species in human evolution; humanity might not be particularly remarkable. You could say humans domesticated rice, but equally, rice domesticated humans—once freely roaming mountains, humans became confined around fields. Many works' "de-anthropocentrism" views humans as Earth's ecological destroyers, even considering humanity Earth's pests[^7]. From a clear Marxist political economy stance, it's genuine **anthropocentrism**—environmental protection aims to preserve biodiversity (symbiosis rather than harmful parasitism), ultimately maintaining this diversity to protect humanity. Human-world interaction constitutes subject-object relationships; transforming the world is natural.
...
$$
\begin{cases}
Superficially\ altruistic: P_{individual} - C_{individual} \leq 0 \newline
Actually\ selfish: P_{gene} - C_{gene} \geq 0
\end{cases} \newline
$$

$$
\begin{cases}
Finite\ game: selfish\ strategy \newline
Infinite\ game: selfish\ strategy \rightarrow cooperative\ strategy
\end{cases}
$$
...
![The article's most incisive viewpoint suggests all assumed altruistic behaviors are actually genetically selfish. Does this truly encompass all morality?](/img/《自私的基因》：利他道德之问.zh-cn-20240523093041798.webp)
...
$$
\begin{align}
R_i &= n \times \left(\frac{1}{2}\right)^{k} \newline
\text{s.t.} & \sum_{i=1}^{n} R_i \times P_i - C \geq 0
\end{align}
$$

{{< admonition tip "Then according to this view, should inbreeding be prevalent?" false >}}
The author's response (the author doesn't directly answer; from indirect discussion I infer his viewpoint): Recessive genetic disease outbreaks cause inbreeding resistance. Thus, second-best becomes "individual altruism," actually "genetic selfishness."
{{< /admonition >}}

{{< admonition tip "How to explain cross-species altruistic behaviors like dolphins saving humans or wolf children?" false >}}
...
![Self-drawn image, economic approach to equilibrium points: Racial selection theory involves individual reproduction demand versus others' reproduction supply; gene selection involves individual allocation between reproduction and rearing. Personally, it's refinement rather than refutation. Analogous to economics, gene selection theory's rearing cost changes partly stem from others' reproduction situations.](/img/《自私的基因》：利他道德之问.zh-cn-20240523093303080.webp)
...
**How to explain female "menopause"?**[^10]
...
![The book decomposes this game into two; here directly integrated into one](/img/《自私的基因》：利他道德之问.zh-cn-20240523093132700.webp)

Regarding **rearing goals**, genes promote certain traits continuously filtered and strengthened—feather color, body structure... If division-of-labor traits like gender, they maintain fluctuating balance. Such division-of-labor advantages emerge relative to other resources, like capital flowing into all profitable areas until various industry profit rates converge[^11].
...
![Insect reproduction cycle diagram](/img/《自私的基因》：利他道德之问.zh-cn-20240523093337516.webp)
...
[^1]: Now equivalent to 5 prefaces: 40th anniversary, 30th anniversary, second edition, preface, foreword
[^2]: Actually gives me a feeling of choosing observation coordinate systems
[^3]: This question comes from "THE BOOK OF WHY"
[^4]: First three chapters introduce and explain concepts
[^5]: Huang Zongzhi. Establishing Forward-Looking Practical Social Science Research: Starting from an Important Shortcoming of Substantivist Theory[J]. Open Times, 2020(1): 18.
[^6]: Title searches yield very few results
[^7]:: Not symbiotic relationships, but harmful parasitism. Visiting Central Academy of Fine Arts exhibitions, many artworks seem to reflect this
[^8]: Evokes welfare economics first theorem
[^9]: I'm contemplating explaining European nations' coexistence and China's unification based on this
